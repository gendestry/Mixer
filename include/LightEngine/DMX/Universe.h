...
{
    class Universe : public Utils::FragmentedStorage<LightEngine::Fixture, 512>
    {
    ...
    public:
        ...
        FixturePtr addFixture(const LightEngine::Fixture& fixture);                 // auto-place
        FixturePtr addFixture(const LightEngine::Fixture& fixture, uint32_t start); // explicit address
        std::vector<FixturePtr> addFixtures(const LightEngine::Fixture& fixture, int count, uint32_t start);
