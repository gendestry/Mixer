...
std::vector<uint16_t> Engine::patch(const std::string &fixtureName, uint8_t universe, uint16_t amount,
                                    std::optional<uint16_t> start, std::optional<uint16_t> startFID) {
...
std::vector<uint16_t> Engine::patch(DMX::Fixture &fixture, uint8_t universe, uint16_t amount,
                                    std::optional<uint16_t> start, std::optional<uint16_t> startFID) {
...
void Engine::update() {
    thread_local auto prevTime = std::chrono::high_resolution_clock::now();
...
std::vector<std::shared_ptr<DMX::Parameters::Parameter> > &Engine::getGroupParameter(
